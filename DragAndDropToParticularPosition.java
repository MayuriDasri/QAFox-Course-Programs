...
public class DragAndDropToParticularPosition {
	...
	public static void main(String[] args) {
		...
		actions.pause(Duration.ofSeconds(2)).dragAndDrop(greenCircle, canBox)
		.pause(Duration.ofSeconds(2)).dragAndDrop(redCircle, canBox)
